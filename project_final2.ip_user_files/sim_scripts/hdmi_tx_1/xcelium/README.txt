...
#
# Generated by export_simulation on Thu Feb 13 11:50:49 CET 2025
#
################################################################################
...
'-reset_run' switch to the './hdmi_tx_1.sh' script.

./hdmi_tx_1.sh -reset_run
...
./hdmi_tx_1.sh -noclean_files

For more information on the script, please type './hdmi_tx_1.sh -help'.
