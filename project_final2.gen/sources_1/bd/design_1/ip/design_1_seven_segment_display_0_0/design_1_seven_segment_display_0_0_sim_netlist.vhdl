...
--               /home/timon/Documents/vivado_snake/project_final2.gen/sources_1/bd/design_1/ip/design_1_seven_segment_display_0_0/design_1_seven_segment_display_0_0_sim_netlist.vhdl
...
entity design_1_seven_segment_display_0_0_seven_segment_display is
  port (
    anodes : out STD_LOGIC_VECTOR ( 3 downto 0 );
    cathodes : out STD_LOGIC_VECTOR ( 5 downto 0 );
    reset : in STD_LOGIC;
    clk : in STD_LOGIC;
    input_number : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_seven_segment_display_0_0_seven_segment_display : entity is "seven_segment_display";
end design_1_seven_segment_display_0_0_seven_segment_display;

architecture STRUCTURE of design_1_seven_segment_display_0_0_seven_segment_display is
  ...
  signal \cathodes[5]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cathodes[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \digit_select[1]_i_1\ : label is "soft_lutpair3";
begin
...
\cathodes[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B0E0A104"
    )
        port map (
...
\cathodes[5]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\cathodes[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EE55F044"
    )
        port map (
...
\cathodes[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFAEAAFAAF"
    )
        port map (
      I0 => digit_select(0),
      I1 => number_value(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_seven_segment_display_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    input_number : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_seven_segment_display_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_seven_segment_display_0_0 : entity is "design_1_seven_segment_display_0_0,seven_segment_display,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_seven_segment_display_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_seven_segment_display_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_seven_segment_display_0_0 : entity is "seven_segment_display,Vivado 2023.1";
end design_1_seven_segment_display_0_0;

architecture STRUCTURE of design_1_seven_segment_display_0_0 is
...
begin
  cathodes(6 downto 2) <= \^cathodes\(6 downto 2);
  cathodes(1) <= \<const0>\;
  cathodes(0) <= \^cathodes\(0);
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
U0: entity work.design_1_seven_segment_display_0_0_seven_segment_display
     port map (
      anodes(3 downto 0) => anodes(3 downto 0),
      cathodes(5 downto 1) => \^cathodes\(6 downto 2),
      cathodes(0) => \^cathodes\(0),
      clk => clk,
