...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, i_switch_up, i_switch_down, 
  i_switch_left, i_switch_right, snake_x, snake_y, pellet_x_in, pellet_y_in, pellet_x, pellet_y, 
  pellet_index_out)
/* synthesis syn_black_box black_box_pad_pin="rst,i_switch_up,i_switch_down,i_switch_left,i_switch_right,snake_x[9:0],snake_y[9:0],pellet_x_in[9:0],pellet_y_in[9:0],pellet_x[9:0],pellet_y[9:0],pellet_index_out[3:0]" */
