...
HD_PWD='/home/timon/Documents/vivado_snake/project_final2.runs/design_1_game_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_game_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_game_logic_0_0.tcl
